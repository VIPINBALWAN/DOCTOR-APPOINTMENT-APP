...
class DoctorProfileEditActivity : AppCompatActivity() {
    ...
    lateinit var edtDhospitalname: EditText
    lateinit var edtDhospitaladdress: EditText
    lateinit var edtDhospitalurl: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtDhospitalname = findViewById(R.id.editDhospitalname)
        edtDhospitaladdress = findViewById(R.id.editDhospitaladdress)
        edtDhospitalurl = findViewById(R.id.editDhospitalurl)
        ...
        db.collection("doctors")
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    edtDhospitalname.setText(doctorData?.hospitalname)
                    edtDhospitaladdress.setText(doctorData?.hospitaladdress)
                    edtDhospitalurl.setText(doctorData?.hospitalurl)
        ...
        btnSaveChanges.setOnClickListener {
            if (edtDName.text.isNotEmpty() &&
                ...
                edtDhospitalname.text.isNotEmpty() &&
                edtDhospitaladdress.text.isNotEmpty() &&
                edtDhospitalurl.text.isNotEmpty() &&
                ...
                AlertDialog.Builder(this).apply {
                    ...
                    setPositiveButton("Yes") { _, _ ->
                        ...
                        val hospitalname = edtDhospitalname.text.toString()
                        val hospitaladdress = edtDhospitaladdress.text.toString()
                        val hospitalurl = edtDhospitalurl.text.toString()
